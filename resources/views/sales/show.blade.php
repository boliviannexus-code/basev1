            ...
            <x-ui.table-card title="Egresos">
                <table class="table table-sm table-vcenter mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td class="text-center text-body-secondary" colspan="7">Sin egresos registrados.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <x-ui.table-card title="Cobros de hospedaje" class="mt-3">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td class="text-center text-body-secondary py-4" colspan="7">Sin cobros de hospedaje.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
