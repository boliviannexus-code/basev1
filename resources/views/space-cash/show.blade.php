...
@section('page-subtitle', 'Cobros de estados de cuenta desde la apertura '.($cashRegister->opened_at?->format('Y-m-d H:i') ?? ''))
...
@section('content')
    ...
    <x-ui.table-card title="Egresos" class="mt-3">
        <table class="table table-hover align-middle mb-0">
            <thead><tr><th>Fecha</th><th>Encargado</th><th>Detalle</th><th class="text-end">Monto</th></tr></thead>
            <tbody>
                ...
                @empty
                    <tr><td class="text-center text-body-secondary py-4" colspan="4">Sin egresos registrados.</td></tr>
                @endforelse
            </tbody>
        </table>
    </x-ui.table-card>
